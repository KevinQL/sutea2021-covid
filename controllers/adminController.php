        ...
        public function administrarPaginasController($session){
            ...
            if($session){
                ...
                if($_SESSION['data']['tipo_usuario']==1){
                    ...
                    "inscripcion_evento", "assistance", "certification", "speakers", "inscripcion_evento_adm", "validar_adm", "transmision", "certificado_digital", "certificado/test-qr" ];
                }else{
                    //Nivel invitado pro defecto
                    $arrayPaginas = ["salir_sistema","inicio","page_sutep","info","inscripcion_evento",  "transmision", "certificado_digital", "certificado/test-qr" ];
                }              
