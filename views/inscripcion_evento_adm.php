...
<body>
      ...
      <div class="card-body">
        ...
        <form action="" method="POST" class="row" id="formInscription">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="inscription_phone" placeholder="Teléfono" autocomplete="off" pattern="^[0-9\\s]+$" minLength="6" maxLength="9">
          </div>
          <div class="col-6 col-md-6 col-lg-4 mb-3">
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-3">
            ...
            <input type="text" class="form-control" id="operation" name="inscription_operation" placeholder="Número de operación" autocomplete="off">
          </div>
  ...
  <!-- AQUÍ SE GUARDAN LA DATA DE LA IMAGEN SUBIDAD *** -->
